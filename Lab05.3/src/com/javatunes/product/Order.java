...
public class Order {
    ...
    /*
    We have three options to delegate to a TaxCalculator:
    1. direct instantiation (not a good solution here)
        if (getLocation() == Location.USA)
        new USATax(); ...
    2.  call out to a factory, eg., TaxCalculatorFactory and ask for it, passing indicator
          This is the option to implement.
    3. let some other party "inject" it and we store it in another field
     */
